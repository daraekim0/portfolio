  ...
  return (
    <>
      ...
      <main className="relative flex-1 overflow-hidden">
        ...
        <section className="grid grid-cols-1 gap-10 px-8 pt-16 pb-16 sm:grid-cols-2 sm:px-12 sm:pt-24">
        ...
        <section className="grid grid-cols-1 gap-10 border-t border-line px-8 py-16 sm:grid-cols-2 sm:px-12">
          <div>
            <h2 className="text-xs uppercase tracking-wide text-muted">
              Things I Love To Do
            </h2>
